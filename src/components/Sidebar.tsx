...
<div className="md:hidden bg-black">
        <header className="fixed top-0  w-full px-3 py-2 border-b border-gray-800 bg-black flex items-center justify-center z-30">
          <Link to="/">
            <span className="text-[#E50914] border-t-2 border-b-2 border-[#E50914] text-xl font-bold">
              GameZone
            </span>
          </Link>
        </header>
              ...
              return (
                <Link
                  ...
                  className={`flex flex-col items-center justify-center text-xs py-2 px-1 rounded-lg transition-colors duration-200 ${
                    isActive ? "text-[#E50914] " : "text-white hover:text-gray-400"
                  }`}
                >
